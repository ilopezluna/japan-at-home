...
import es.japanathome.domain.Authority;
import es.japanathome.domain.PersistentToken;
import es.japanathome.domain.User;
import es.japanathome.repository.PersistentTokenRepository;
import es.japanathome.repository.UserRepository;
import es.japanathome.security.SecurityUtils;
import es.japanathome.service.MailService;
import es.japanathome.service.UserService;
import es.japanathome.web.rest.dto.UserDTO;
